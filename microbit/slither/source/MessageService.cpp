...
namespace slither {
    ...
    void MessageService::initialize() {
        ...
        GattCharacteristic messageCharacteristic(MessageTxCharacteristicUUID, buffer, 0, 128,
    ...
    const uint8_t MessageTxCharacteristicUUID[] = {
            0xe4, 0x99, 0x0f, 0x36, 0x28, 0xf4, 0x40, 0xd8, 0xbf, 0xa2, 0xf0, 0x51, 0x18, 0x72, 0x0a, 0x28
    };

    const uint8_t MessageRxCharacteristicUUID[] = {
